...
const Contacts=()=>{
    ...
    if(form.current[0].value.length>0 && form.current[1].value.length>0){
        ...
        emailjs.sendForm('service_e0iih9e', 'template_bkrfm9s', form.current, 'BpalnPa0xN3IZ7sON')
        .then((result) => {
    ...
    return (
        ...
        <br/>
        <label>Email</label>
        <input placeholder="Enter your mail-address:" type="email" name="user_email" />
        <br/>
        <label>Message</label>
